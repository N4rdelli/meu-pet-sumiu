...
// Importa a classe de conexão com o banco de dados, UsuarioDAO é uma subclasse
class UsuarioDAO extends Conexao
{
    ...
    public function inserir($usuario)
    {
        ...
        try {
            ...
            // Substitui os pontos de interrogação pelos valores que estão no objeto $usuario
